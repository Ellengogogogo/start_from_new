...
export default function UserTypePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-16 font-sans">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Wählen Sie Ihren Benutzertyp, um mit der Erstellung Ihres Exposés fortzufahren
          </p>
        </div>
        ...
        <div className="flex justify-center mb-16">
          <div className="flex items-center space-x-6">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-sm font-semibold text-blue-600">Benutzertyp</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-3 text-sm font-medium text-gray-500">Immobiliendaten</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors font-medium text-sm group"
          >
